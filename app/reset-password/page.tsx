...
// The session is already established by the Route Handler at
// /auth/confirm before the user lands here. This page only needs
// to show the password form and call updateUser({ password }).
